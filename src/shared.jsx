...
const EP = {
  ...
  links: [
    { label: "Bandcamp",    url: "https://makotyo.bandcamp.com/album/polished-flame", primary: true,  note: "EP 試聴 / 購入 / DL" },
    { label: "SoundCloud",  url: "https://soundcloud.com/makotyo", primary: false, note: "@makotyo" },
    { label: "X",           url: "https://x.com/doskoi_maco", primary: false, note: "@doskoi_maco" },
  ],
  profile: {
